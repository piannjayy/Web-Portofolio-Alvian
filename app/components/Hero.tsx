...
export default function Hero() {
  ...
  return (
    <section ref={containerRef} id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden bg-[#e2e8f0] dark:bg-[#0a0a0a] transition-colors duration-500">
      ...
      {/* Background Decorative - Cahaya samar di belakang teks */}
      ...
      >
        ...
        >
          <a 
            href="#projects" 
            className="group relative bg-slate-950 dark:bg-white text-white dark:text-black px-10 py-4 rounded-full font-bold overflow-hidden transition-all hover:scale-105 active:scale-95 shadow-2xl shadow-slate-950/20"
          >
          ...
          <a 
            href="#contact" 
            className="group text-sm uppercase tracking-widest font-bold text-slate-950 dark:text-white flex items-center gap-2"
          >
            Hubungi Saya
